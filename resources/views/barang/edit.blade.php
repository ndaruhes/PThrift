@extends('layouts.app')
@section('title', $barang->nama_barang . ' - Edit Barang | PThrift')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control @error('harga_barang') is-invalid @enderror"
                                placeholder="Masukkan harga barang" name="harga_barang" value="{{ $barang->harga_barang }}">
                            @error('harga_barang')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control description  @error('deskripsi_barang') is-invalid @enderror"
                            placeholder="Masukkan deskripsi barang" name="deskripsi_barang">{{ $barang->deskripsi_barang }}</textarea>
